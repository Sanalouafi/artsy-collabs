                ...
                @foreach ($projects as $project)
                    <div class="max-w-sm w-full lg:max-w-full lg:flex pt-10">
                        ...
                        <div
                            ...
                            <!-- Collaborate Button and Modal -->
                            <div class="flex items-center">
                                <!-- Collaborate Button -->
                                <button type="button" data-modal-target="collaborate-modal-{{ $project->id }}"
                                    data-modal-toggle="collaborate-modal-{{ $project->id }}"
                                ...
                                <!-- Collaborate Modal -->
                                <div id="collaborate-modal-{{ $project->id }}" tabindex="-1" aria-hidden="true"
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-modal-hide="collaborate-modal-{{ $project->id }}">
                                            ...
                                            <div class="p-4 md:p-5">
                                                <form method="POST" action="{{ route('projectUsers.store') }}"
                                                    id="collaborateForm" class="flex flex-col">
                                                    @csrf
                                                    <div class="pb-5">
